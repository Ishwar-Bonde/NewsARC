package news.operational.NewsGO.ui.home;
...
public class home extends Fragment {
    ...
    private void getNews(String query){
        ...
        if (query.isEmpty()) {
            ...
            url = "https://newsapi.org/v2/top-headlines?country=us&category=general&from="+yesterdayString+"&to="+todayString+"&language="+selectedLanguage+"&apiKey="+ ApiKeys.NEWS_API_KEY;
        } else {
