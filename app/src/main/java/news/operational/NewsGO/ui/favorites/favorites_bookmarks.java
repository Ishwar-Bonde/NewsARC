package news.operational.NewsGO.ui.favorites;
...
public class favorites_bookmarks extends Fragment {
    private RecyclerView newsRV,categoryRV;
    private ProgressBar loadingPB;
    private ArrayList<Articles> articlesArrayList;
    private NewsRVAdapter newsRVAdapter;

    private FavoritesBookmarksViewModel mViewModel;
    private static final String KEY_NEWS_LANGUAGE = "news_language";
    SharedPreferences sharedPreferences;
    SwipeRefreshLayout swipeRefreshLayout;

    public static favorites_bookmarks newInstance() {
        return new favorites_bookmarks();
    }

    @Override
    public View onCreateView(@NonNull LayoutInflater inflater, @Nullable ViewGroup container,
                             @Nullable Bundle savedInstanceState) {
        View root = inflater.inflate(R.layout.fragment_favorites_bookmarks, container, false);
        ...
        swipeRefreshLayout = root.findViewById(R.id.swipe_fav_books);
    ...
    private void getNews(String category){
        ...
        if (category.isEmpty()) {
            ...
            url = "https://newsapi.org/v2/top-headlines?country="+country+"&category=science&from="+yesterdayString+"&to="+todayString+"&language="+selectedLanguage+"&apiKey="+ ApiKeys.NEWS_API_KEY;
        } else {
