package news.operational.NewsGO.ui.categories;
...
public class categories extends Fragment {
    ...
    private void getNews(String category){
        ...
        String url2 = "https://newsapi.org/v2/top-headlines?country=us&category="+category+"&from="+yesterdayString+"&to="+todayString+"&apiKey="+ ApiKeys.NEWS_API_KEY;
