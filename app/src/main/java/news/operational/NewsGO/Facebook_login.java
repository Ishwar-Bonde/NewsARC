...
public class Facebook_login extends LoginActivity {
        ...
        LoginManager.getInstance().registerCallback(callbackManager,
                new FacebookCallback<LoginResult>() {
                    ...
                    public void onSuccess(LoginResult loginResult) {
                        ...
                        startActivity(new Intent(Facebook_login.this, homePage.class));
                        finish();
                    }
                ...
                .addOnCompleteListener(this, new OnCompleteListener<AuthResult>() {
                    ...
                    public void onComplete(@NonNull Task<AuthResult> task) {
                        if (task.isSuccessful()) {
                            ...
                            Toast.makeText(Facebook_login.this, ""+task.getException(),
    ...
    private void updateUI(FirebaseUser user) {
        Intent intent = new Intent(Facebook_login.this, homePage.class);
